-- ============================================================================
-- Migration V1.7 · goodle_apps.model_settings_json column
-- ----------------------------------------------------------------------------
...
-- against the app instead of the underlying goodle_model row, so switching
...
-- runtime via AgentChatOptionsFactory using goodle_apps.model_provider, so the row
