-- ============================================================================
-- Migration V1.2 · Add Dify-parity presentation + retrieval columns to goodle_apps
-- ----------------------------------------------------------------------------
-- The `goodle_apps` table (formerly `agent_definition`) was created with the minimum
...
ALTER TABLE goodle_apps ADD COLUMN IF NOT EXISTS description              VARCHAR(1024);
ALTER TABLE goodle_apps ADD COLUMN IF NOT EXISTS icon                     VARCHAR(64);
ALTER TABLE goodle_apps ADD COLUMN IF NOT EXISTS icon_background          VARCHAR(32);
ALTER TABLE goodle_apps ADD COLUMN IF NOT EXISTS mode                     VARCHAR(32) DEFAULT 'agent';
ALTER TABLE goodle_apps ADD COLUMN IF NOT EXISTS opening_statement        TEXT;
ALTER TABLE goodle_apps ADD COLUMN IF NOT EXISTS suggested_questions_json TEXT;
ALTER TABLE goodle_apps ADD COLUMN IF NOT EXISTS dataset_ids_json         TEXT;
ALTER TABLE goodle_apps ADD COLUMN IF NOT EXISTS published                BOOLEAN DEFAULT TRUE;
