...
/**
 * OpenAPI 3 auto-config for spring-agent-start-web. Loaded only when springdoc is on
 * the classpath (springdoc-openapi-starter-webflux-ui is declared optional in
 * the library pom; the runnable spring-agent-start-server always pulls it in).
 * <p>
