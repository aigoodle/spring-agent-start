...
public class GoodleOpenApiConfig {

    @Bean
    public OpenAPI springAgentOpenApi(GoodleWebProperties properties) {
        String serverUrl = GoodleWebAutoConfiguration.normalizedBasePath(properties.getBasePath());
