...
/**
 * The 1:1 sidecar of an {@link AppEntity} carrying everything about
 ...
 * of the agent module already uses (see {@link AppEntity}). Callers
...
public class AppModelConfigEntity extends BaseEntity {
